...
oot_channel_id_list = ["705975264055787530","705975264055787530","706468631432659006","713009844923400223","698565842354438244","713009844923400223","699517929435168768","705975264055787530","716276018263883827"]
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="__Trivia Support Pro🥒__", description= '```Đã kết nối tới con Kumu Private...🤖```',colour = discord.Colour.red())
